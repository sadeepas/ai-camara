...
Download a pre-trained FER-2013 Keras model (you can find these on GitHub or Kaggle).

Rename the downloaded file to emotion_model.h5.

Replace the file in your project directory.
...
Create your feature branch (git checkout -b feature/NewFilter).

Commit your changes (git commit -m 'Add NewFilter').

Push to the branch (git push origin feature/NewFilter).
